          ...
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-700 rounded-lg bg-neutral-900 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
            <li>
              <button
                ...
                className="block py-2 px-3 text-white bg-neutral-700 rounded-sm md:bg-transparent md:text-[#4FB777] md:p-0 w-full text-left cursor-pointer hover:bg-gray-700 md:hover:bg-transparent md:border-0 md:hover:text-[#4FB777]"
              >
                Home
              </button>
            </li>
            <li>
              <button
                onClick={() => handleSmoothScroll("intro")}
