...
function Footer() {
    return (
        <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-[#1E1E1E] dark:text-neutral-200 lg:text-left">
                ...
                <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-2">
                    <div>
                        <h6 className="flex items-center justify-center font-semibold uppercase md:justify-start">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="mr-3 h-25 w-60">
            ...
            <div className="bg-[#18181C] p-6 flex justify-between text-white">
